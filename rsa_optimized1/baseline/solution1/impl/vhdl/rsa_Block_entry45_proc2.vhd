...
entity rsa_Block_entry45_proc2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of rsa_Block_entry45_proc2 is 
...
attribute shreg_extract : string;
    ...
    signal grp_mod_exp_fu_39_ap_start : STD_LOGIC;
...
begin
    grp_mod_exp_fu_39 : component rsa_mod_exp
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((grp_mod_exp_fu_39_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    grp_mod_exp_fu_39_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_mod_exp_fu_39_ap_start_reg <= ap_const_logic_0;
            else
                if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    grp_mod_exp_fu_39_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_mod_exp_fu_39_ap_ready = ap_const_logic_1)) then 
                    grp_mod_exp_fu_39_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, grp_mod_exp_fu_39_ap_done, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
    ...
    ap_ST_fsm_state2_blk_assign_proc : process(grp_mod_exp_fu_39_ap_done)
    begin
        if ((grp_mod_exp_fu_39_ap_done = ap_const_logic_0)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, grp_mod_exp_fu_39_ap_done, ap_CS_fsm_state2)
    begin
        if (((grp_mod_exp_fu_39_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_ready_assign_proc : process(grp_mod_exp_fu_39_ap_done, ap_CS_fsm_state2)
    begin
        if (((grp_mod_exp_fu_39_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    grp_mod_exp_fu_39_ap_start <= grp_mod_exp_fu_39_ap_start_reg;

    x_assign_proc : process(grp_mod_exp_fu_39_ap_done, grp_mod_exp_fu_39_ap_return, ap_CS_fsm_state2, x_preg)
    begin
        if (((grp_mod_exp_fu_39_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    x_ap_vld_assign_proc : process(grp_mod_exp_fu_39_ap_done, ap_CS_fsm_state2)
    begin
        if (((grp_mod_exp_fu_39_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
