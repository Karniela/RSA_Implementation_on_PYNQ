...
add_files rsa.h
add_files rsa.cpp
<<<<<<< HEAD:rsa_baseline/rsa_baseline_hls/solution1/script.tcl
...
=======
add_files -tb data/input.txt -cflags "-Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"
add_files -tb data/golden.txt -cflags "-Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"
add_files -tb rsa_test.cpp -cflags "-Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"
>>>>>>> origin/branch2:rsa_baseline/baseline/solution1/script.tcl
