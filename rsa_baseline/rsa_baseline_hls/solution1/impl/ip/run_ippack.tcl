...
set xo_kernel_name "rsa"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/cse237c_fa24_y_liao/Desktop/RSA_Implementation_on_PYNQ/rsa_baseline/rsa_baseline_hls/solution1"
set debug_dir "/home/cse237c_fa24_y_liao/Desktop/RSA_Implementation_on_PYNQ/rsa_baseline/rsa_baseline_hls/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {rsa_mul_256ns_256ns_512_5_1
rsa_urem_512ns_256ns_256_516_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 d_1 W 0x0 "Data signal of d" {{0 32 d W 0 "Bit 31 to 0 of d"}}} {0x14 d_2 W 0x0 "Data signal of d" {{0 32 d W 0 "Bit 63 to 32 of d"}}} {0x18 d_3 W 0x0 "Data signal of d" {{0 32 d W 0 "Bit 95 to 64 of d"}}} {0x1c d_4 W 0x0 "Data signal of d" {{0 32 d W 0 "Bit 127 to 96 of d"}}} {0x20 d_5 W 0x0 "Data signal of d" {{0 32 d W 0 "Bit 159 to 128 of d"}}} {0x24 d_6 W 0x0 "Data signal of d" {{0 32 d W 0 "Bit 191 to 160 of d"}}} {0x28 d_7 W 0x0 "Data signal of d" {{0 32 d W 0 "Bit 223 to 192 of d"}}} {0x2c d_8 W 0x0 "Data signal of d" {{0 32 d W 0 "Bit 255 to 224 of d"}}} {0x34 N_1 W 0x0 "Data signal of N" {{0 32 N W 0 "Bit 31 to 0 of N"}}} {0x38 N_2 W 0x0 "Data signal of N" {{0 32 N W 0 "Bit 63 to 32 of N"}}} {0x3c N_3 W 0x0 "Data signal of N" {{0 32 N W 0 "Bit 95 to 64 of N"}}} {0x40 N_4 W 0x0 "Data signal of N" {{0 32 N W 0 "Bit 127 to 96 of N"}}} {0x44 N_5 W 0x0 "Data signal of N" {{0 32 N W 0 "Bit 159 to 128 of N"}}} {0x48 N_6 W 0x0 "Data signal of N" {{0 32 N W 0 "Bit 191 to 160 of N"}}} {0x4c N_7 W 0x0 "Data signal of N" {{0 32 N W 0 "Bit 223 to 192 of N"}}} {0x50 N_8 W 0x0 "Data signal of N" {{0 32 N W 0 "Bit 255 to 224 of N"}}} {0x58 y_1 W 0x0 "Data signal of y" {{0 32 y W 0 "Bit 31 to 0 of y"}}} {0x5c y_2 W 0x0 "Data signal of y" {{0 32 y W 0 "Bit 63 to 32 of y"}}} {0x60 y_3 W 0x0 "Data signal of y" {{0 32 y W 0 "Bit 95 to 64 of y"}}} {0x64 y_4 W 0x0 "Data signal of y" {{0 32 y W 0 "Bit 127 to 96 of y"}}} {0x68 y_5 W 0x0 "Data signal of y" {{0 32 y W 0 "Bit 159 to 128 of y"}}} {0x6c y_6 W 0x0 "Data signal of y" {{0 32 y W 0 "Bit 191 to 160 of y"}}} {0x70 y_7 W 0x0 "Data signal of y" {{0 32 y W 0 "Bit 223 to 192 of y"}}} {0x74 y_8 W 0x0 "Data signal of y" {{0 32 y W 0 "Bit 255 to 224 of y"}}} {0x7c x_1 R 0x0 "Data signal of x" {{0 32 x R 0 "Bit 31 to 0 of x"}}} {0x80 x_2 R 0x0 "Data signal of x" {{0 32 x R 0 "Bit 63 to 32 of x"}}} {0x84 x_3 R 0x0 "Data signal of x" {{0 32 x R 0 "Bit 95 to 64 of x"}}} {0x88 x_4 R 0x0 "Data signal of x" {{0 32 x R 0 "Bit 127 to 96 of x"}}} {0x8c x_5 R 0x0 "Data signal of x" {{0 32 x R 0 "Bit 159 to 128 of x"}}} {0x90 x_6 R 0x0 "Data signal of x" {{0 32 x R 0 "Bit 191 to 160 of x"}}} {0x94 x_7 R 0x0 "Data signal of x" {{0 32 x R 0 "Bit 223 to 192 of x"}}} {0x98 x_8 R 0x0 "Data signal of x" {{0 32 x R 0 "Bit 255 to 224 of x"}}} {0x9c x_ctrl R 0x0 "Control signal of x" {{0 1 x_ap_vld R 0 "Control signal x_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
