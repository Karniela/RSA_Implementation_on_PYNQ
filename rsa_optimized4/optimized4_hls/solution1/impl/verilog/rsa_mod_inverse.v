...
wire   [0:0] icmp_ln126_fu_119_p2;
wire   [127:0] grp_fu_150_p2;
reg   [127:0] ret_V_reg_250;
wire    ap_CS_fsm_state133;
wire   [128:0] x0_V_2_fu_203_p2;
wire    ap_CS_fsm_state134;
wire    grp_multi_stage_mul_x0_fu_91_ap_start;
wire    grp_multi_stage_mul_x0_fu_91_ap_done;
wire    grp_multi_stage_mul_x0_fu_91_ap_idle;
wire    grp_multi_stage_mul_x0_fu_91_ap_ready;
wire   [128:0] grp_multi_stage_mul_x0_fu_91_ap_return;
reg   [128:0] x1_V_reg_66;
reg   [128:0] x0_V_3_reg_78;
reg    grp_multi_stage_mul_x0_fu_91_ap_start_reg;
reg   [7:0] i_fu_42;
wire   [7:0] i_6_fu_125_p2;
wire   [0:0] icmp_ln1039_fu_144_p2;
reg   [127:0] a_buf_0_fu_46;
reg   [127:0] ret_V_5_fu_50;
wire   [127:0] grp_fu_157_p2;
wire   [126:0] tmp_fu_134_p4;
wire   [127:0] trunc_ln840_fu_181_p1;
wire   [0:0] tmp_1_fu_173_p3;
wire   [127:0] add_ln142_fu_185_p2;
reg    grp_fu_150_ap_start;
wire    grp_fu_150_ap_done;
reg    grp_fu_157_ap_start;
wire    grp_fu_157_ap_done;
wire   [127:0] select_ln142_fu_190_p3;
...
initial begin
#0 ap_CS_fsm = 134'd1;
#0 grp_multi_stage_mul_x0_fu_91_ap_start_reg = 1'b0;
#0 ap_return_preg = 128'd0;
end

rsa_multi_stage_mul_x0 grp_multi_stage_mul_x0_fu_91(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(grp_multi_stage_mul_x0_fu_91_ap_start),
    .ap_done(grp_multi_stage_mul_x0_fu_91_ap_done),
    .ap_idle(grp_multi_stage_mul_x0_fu_91_ap_idle),
    .ap_ready(grp_multi_stage_mul_x0_fu_91_ap_ready),
    .a(ret_V_reg_250),
    .b(x0_V_3_reg_78),
    .ap_return(grp_multi_stage_mul_x0_fu_91_ap_return)
);
...
udiv_128ns_128ns_128_132_seq_1_U9(
    .clk(ap_clk),
    .reset(ap_rst),
    .start(grp_fu_150_ap_start),
    .done(grp_fu_150_ap_done),
    .din0(a_buf_0_fu_46),
    .din1(ret_V_5_fu_50),
    .ce(1'b1),
    .dout(grp_fu_150_p2)
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state2) & ((icmp_ln1039_fu_144_p2 == 1'd1) | (icmp_ln126_fu_119_p2 == 1'd1)))) begin
            ap_return_preg <= select_ln142_fu_190_p3;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_multi_stage_mul_x0_fu_91_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state133)) begin
            grp_multi_stage_mul_x0_fu_91_ap_start_reg <= 1'b1;
        end else if ((grp_multi_stage_mul_x0_fu_91_ap_ready == 1'b1)) begin
            grp_multi_stage_mul_x0_fu_91_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        a_buf_0_fu_46 <= a;
    end else if (((icmp_ln1039_fu_144_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln126_fu_119_p2 == 1'd0))) begin
        a_buf_0_fu_46 <= ret_V_5_fu_50;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        ret_V_5_fu_50 <= grp_fu_157_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state134) & (grp_multi_stage_mul_x0_fu_91_ap_done == 1'b1))) begin
        x0_V_3_reg_78 <= x0_V_2_fu_203_p2;
    end else if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        x0_V_3_reg_78 <= 129'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state134) & (grp_multi_stage_mul_x0_fu_91_ap_done == 1'b1))) begin
        x1_V_reg_66 <= x0_V_3_reg_78;
    end else if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        x1_V_reg_66 <= 129'd1;
    end
end
...
always @ (*) begin
    if ((grp_multi_stage_mul_x0_fu_91_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state2) & ((icmp_ln1039_fu_144_p2 == 1'd1) | (icmp_ln126_fu_119_p2 == 1'd1))) | ((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & ((icmp_ln1039_fu_144_p2 == 1'd1) | (icmp_ln126_fu_119_p2 == 1'd1)))) begin
        ap_return = select_ln142_fu_190_p3;
    end else begin
...
always @ (*) begin
    if (((icmp_ln1039_fu_144_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln126_fu_119_p2 == 1'd0))) begin
        grp_fu_150_ap_start = 1'b1;
    end else begin
        grp_fu_150_ap_start = 1'b0;
    end
end
...
assign add_ln142_fu_185_p2 = (trunc_ln840_fu_181_p1 + mod_r);
...
assign grp_multi_stage_mul_x0_fu_91_ap_start = grp_multi_stage_mul_x0_fu_91_ap_start_reg;

assign i_6_fu_125_p2 = (i_fu_42 + 8'd1);

assign icmp_ln1039_fu_144_p2 = ((tmp_fu_134_p4 == 127'd0) ? 1'b1 : 1'b0);

assign icmp_ln126_fu_119_p2 = ((i_fu_42 == 8'd128) ? 1'b1 : 1'b0);

assign select_ln142_fu_190_p3 = ((tmp_1_fu_173_p3[0:0] == 1'b1) ? add_ln142_fu_185_p2 : trunc_ln840_fu_181_p1);

assign tmp_1_fu_173_p3 = x1_V_reg_66[32'd128];

assign tmp_fu_134_p4 = {{a_buf_0_fu_46[127:1]}};

assign trunc_ln840_fu_181_p1 = x1_V_reg_66[127:0];

assign x0_V_2_fu_203_p2 = (x1_V_reg_66 - grp_multi_stage_mul_x0_fu_91_ap_return);
