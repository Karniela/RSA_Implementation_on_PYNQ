...
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>.186"(%"struct.ap_uint<256>"* %0, i256* align 512 %1)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>.186"(%"struct.ap_uint<256>"* noalias "unpacked"="0", i256* noalias nocapture readonly align 512 "unpacked"="1.0.0.0") unnamed_addr #3 {
entry:
