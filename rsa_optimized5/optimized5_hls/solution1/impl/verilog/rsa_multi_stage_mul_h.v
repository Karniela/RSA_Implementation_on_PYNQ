...
wire   [0:0] icmp_ln104_fu_110_p2;
reg    ap_condition_exit_pp0_iter1_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
reg   [255:0] a_buf_0_load_reg_209;
wire   [254:0] trunc_ln104_fu_133_p1;
reg   [254:0] trunc_ln104_reg_214;
...
reg   [7:0] i_01_fu_36;
wire   [7:0] i_3_fu_116_p2;
wire    ap_loop_init;
reg   [255:0] m_V_2_fu_40;
reg   [255:0] ap_sig_allocacmp_m_V_2_load_1;
reg   [255:0] ap_sig_allocacmp_m_V_2_load;
reg   [255:0] a_buf_0_fu_44;
wire  signed [255:0] sext_ln186_fu_79_p1;
reg   [255:0] ap_sig_allocacmp_a_buf_0_load;
reg   [255:0] t_V_2_fu_48;
wire   [255:0] zext_ln186_fu_83_p1;
reg   [255:0] ap_sig_allocacmp_t_V_2_load;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            i_01_fu_36 <= 8'd0;
        end else if (((icmp_ln104_fu_110_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln104_fu_110_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln104_fu_110_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign ap_return = ap_sig_allocacmp_m_V_2_load;

assign grp_multi_stage_mul_h_add_m_fu_64_a = ap_sig_allocacmp_a_buf_0_load[0:0];

assign i_3_fu_116_p2 = (i_01_fu_36 + 8'd1);

assign icmp_ln104_fu_110_p2 = ((i_01_fu_36 == 8'd129) ? 1'b1 : 1'b0);

assign sext_ln186_fu_79_p1 = $signed(a);

assign trunc_ln104_fu_133_p1 = ap_sig_allocacmp_t_V_2_load[254:0];
