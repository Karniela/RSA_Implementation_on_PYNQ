...
reg   [7:0] i_fu_36;
wire   [7:0] i_2_fu_112_p2;
wire    ap_loop_init;
wire    ap_block_pp0_stage0_11001;
reg   [7:0] ap_sig_allocacmp_i_1;
reg   [128:0] m_V_1_fu_40;
reg   [128:0] ap_sig_allocacmp_m_V_1_load;
reg   [128:0] a_buf_0_fu_44;
wire   [128:0] a_cast_fu_79_p1;
reg   [128:0] t_V_1_fu_48;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln130_fu_106_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln130_fu_106_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ap_sig_allocacmp_m_V_1_load = 129'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
...
assign ap_return = ap_sig_allocacmp_m_V_1_load;

assign call_ret5_multi_stage_mul_x0_update_m_t_a_fu_71_t_V_read = t_V_1_fu_48[127:0];

assign i_2_fu_112_p2 = (ap_sig_allocacmp_i_1 + 8'd1);

assign icmp_ln130_fu_106_p2 = ((ap_sig_allocacmp_i_1 == 8'd129) ? 1'b1 : 1'b0);
