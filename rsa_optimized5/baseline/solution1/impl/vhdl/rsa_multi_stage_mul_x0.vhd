...
attribute shreg_extract : string;
    ...
    signal icmp_ln130_fu_106_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_2_fu_112_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal ap_sig_allocacmp_i_1 : STD_LOGIC_VECTOR (7 downto 0);
    signal m_V_1_fu_40 : STD_LOGIC_VECTOR (128 downto 0);
    signal ap_sig_allocacmp_m_V_1_load : STD_LOGIC_VECTOR (128 downto 0);
    signal a_buf_0_fu_44 : STD_LOGIC_VECTOR (128 downto 0);
    signal a_cast_fu_79_p1 : STD_LOGIC_VECTOR (128 downto 0);
    signal t_V_1_fu_48 : STD_LOGIC_VECTOR (128 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln130_fu_106_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_36 <= i_2_fu_112_p2;
    ...
    m_V_1_fu_40_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    m_V_1_fu_40 <= ap_const_lv129_lc_1;
                elsif ((ap_enable_reg_pp0_iter1 = ap_const_logic_1)) then 
                    m_V_1_fu_40 <= call_ret5_multi_stage_mul_x0_update_m_t_a_fu_71_ap_return_0;
                end if;
            end if; 
        end if;
    end process;

    t_V_1_fu_48_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    t_V_1_fu_48 <= call_ret5_multi_stage_mul_x0_update_m_t_a_fu_71_ap_return_1;
                end if;
            end if; 
        end if;
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln130_fu_106_p2)
    begin
        if (((icmp_ln130_fu_106_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_return <= ap_sig_allocacmp_m_V_1_load;
    ...
    ap_sig_allocacmp_m_V_1_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, call_ret5_multi_stage_mul_x0_update_m_t_a_fu_71_ap_return_0, ap_block_pp0_stage0, ap_loop_init, m_V_1_fu_40)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
            if ((ap_loop_init = ap_const_logic_1)) then 
                ap_sig_allocacmp_m_V_1_load <= ap_const_lv129_lc_1;
            elsif ((ap_enable_reg_pp0_iter1 = ap_const_logic_1)) then 
                ap_sig_allocacmp_m_V_1_load <= call_ret5_multi_stage_mul_x0_update_m_t_a_fu_71_ap_return_0;
            else 
                ap_sig_allocacmp_m_V_1_load <= m_V_1_fu_40;
            end if;
        else 
            ap_sig_allocacmp_m_V_1_load <= m_V_1_fu_40;
        end if; 
    ...
    call_ret5_multi_stage_mul_x0_update_m_t_a_fu_71_t_V_read <= t_V_1_fu_48(128 - 1 downto 0);
    i_2_fu_112_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv8_1));
    icmp_ln130_fu_106_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv8_81) else "0";
