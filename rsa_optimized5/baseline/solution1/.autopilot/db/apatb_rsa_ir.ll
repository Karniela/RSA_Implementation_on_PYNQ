; ModuleID = '/home/cse237c_fa24_s_chen/RSA_Implementation_on_PYNQ/rsa_optimized4/baseline/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_rsa_ir(%"struct.ap_uint<128>"* nocapture readonly %p, %"struct.ap_uint<128>"* nocapture readonly %q, %"struct.ap_uint<256>"* nocapture readonly %d, %"struct.ap_uint<256>"* nocapture readonly %N, %"struct.ap_uint<256>"* nocapture readonly %y, %"struct.ap_uint<256>"* noalias nocapture nonnull dereferenceable(32) %x) local_unnamed_addr #0 {
entry:
  %x_copy = alloca i256, align 512
  call fastcc void @copy_in(%"struct.ap_uint<256>"* nonnull %x, i256* nonnull align 512 %x_copy)
  call void @apatb_rsa_hw(%"struct.ap_uint<128>"* %p, %"struct.ap_uint<128>"* %q, %"struct.ap_uint<256>"* %d, %"struct.ap_uint<256>"* %N, %"struct.ap_uint<256>"* %y, i256* %x_copy)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>.226"(%"struct.ap_uint<256>"* %0, i256* align 512 %1)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>.226"(%"struct.ap_uint<256>"* noalias "unpacked"="0", i256* noalias nocapture readonly align 512 "unpacked"="1.0.0.0") unnamed_addr #3 {
entry:
...
declare void @apatb_rsa_hw(%"struct.ap_uint<128>"*, %"struct.ap_uint<128>"*, %"struct.ap_uint<256>"*, %"struct.ap_uint<256>"*, %"struct.ap_uint<256>"*, i256*)
...
define void @rsa_hw_stub_wrapper(%"struct.ap_uint<128>"*, %"struct.ap_uint<128>"*, %"struct.ap_uint<256>"*, %"struct.ap_uint<256>"*, %"struct.ap_uint<256>"*, i256*) #4 {
entry:
  %6 = alloca %"struct.ap_uint<256>"
  call void @copy_out(%"struct.ap_uint<256>"* %6, i256* %5)
  call void @rsa_hw_stub(%"struct.ap_uint<128>"* %0, %"struct.ap_uint<128>"* %1, %"struct.ap_uint<256>"* %2, %"struct.ap_uint<256>"* %3, %"struct.ap_uint<256>"* %4, %"struct.ap_uint<256>"* %6)
  call void @copy_in(%"struct.ap_uint<256>"* %6, i256* %5)
  ret void
}

declare void @rsa_hw_stub(%"struct.ap_uint<128>"*, %"struct.ap_uint<128>"*, %"struct.ap_uint<256>"*, %"struct.ap_uint<256>"*, %"struct.ap_uint<256>"*, %"struct.ap_uint<256>"*)
