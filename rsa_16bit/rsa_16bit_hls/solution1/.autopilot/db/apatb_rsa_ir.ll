; ModuleID = '/home/cse237c_fa24_y_liao/Desktop/rsa_baseline_hls/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<16>.4"(%"struct.ap_uint<16>"* %0, i16* align 512 %1)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<16>.4"(%"struct.ap_uint<16>"* noalias "unpacked"="0", i16* noalias nocapture readonly align 512 "unpacked"="1.0.0.0") unnamed_addr #3 {
entry:
