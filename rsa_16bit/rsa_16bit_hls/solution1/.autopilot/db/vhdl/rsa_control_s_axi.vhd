...
architecture behave of rsa_control_s_axi is
    ...
    constant ADDR_D_CTRL   : INTEGER := 16#14#;
    ...
    constant ADDR_X_CTRL   : INTEGER := 16#2c#;
    ...
    signal int_d               : UNSIGNED(15 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_D_DATA_0 =>
                        rdata_data <= RESIZE(int_d(15 downto 0), 32);
                    when ADDR_N_DATA_0 =>
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_D_DATA_0) then
                    int_d(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_d(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_N_DATA_0) then
                    int_N(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_N(15 downto 0));
                end if;
            end if;
        end if;
    end process;
